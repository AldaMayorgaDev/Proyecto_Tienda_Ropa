...
$consulta = "SELECT id, nombre, apellidos, matricula, telefono FROM alumnos";
...
<!--         <h3 class="text-center text-light">Tutorial</h3>-->
         <h4 class="text-center text-light">CRUD con <span class="badge badge-danger">En Alumnos</span></h4> 
     </header>    
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="tablaAlumnos" class="table table-striped table-bordered table-condensed" style="width:100%">
